...
const addHeartController = async (req, res) => {
    ...
    try {
        if (yourUID && otherUserUID) {
            const transformedYourUID = (0, helpers_1.stringToObjectId)(yourUID);
            const transformedOtherUserUID = (0, helpers_1.stringToObjectId)(otherUserUID);
...
const getAllHeartController = async (req, res) => {
    ...
    try {
        if (uid) {
            const transformedUID = (0, helpers_1.stringToObjectId)(uid);
