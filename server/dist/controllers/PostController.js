...
const savePostController = async (req, res) => {
    ...
    try {
        if (uid) {
            const _id = (0, helpers_1.stringToObjectId)(uid);
...
const fetchPostsController = async (req, res) => {
    ...
    try {
        if (vieweruid !== null && vieweruid !== undefined && vieweruid !== "null") {
            const objectId = (0, helpers_1.stringToObjectId)(uid);
            const objectViewerUID = (0, helpers_1.stringToObjectId)(vieweruid);
            const skip = 0;
            const limit = 5;
...
const fetchHomePostsController = async (req, res) => {
    ...
    try {
        if (vieweruid !== null && vieweruid !== undefined && vieweruid !== "null") {
            const objectViewerUID = (0, helpers_1.stringToObjectId)(vieweruid.toString());
            const skip = 0;
            const limit = 5;
            const posts = await Post_1.PostModel.aggregate([
                { $sort: { createdAt: -1 } },
...
const incrementLikeController = async (req, res) => {
    ...
    try {
        if (postId && userId) {
            const objectPostId = (0, helpers_1.stringToObjectId)(postId);
            const objectUserId = (0, helpers_1.stringToObjectId)(userId);
...
const addCommentController = async (req, res) => {
    try {
        ...
        if (uid && postId && comment) {
            const objectUID = (0, helpers_1.stringToObjectId)(uid);
            const objectPostId = (0, helpers_1.stringToObjectId)(postId);
...
const deleteCommentController = async (req, res) => {
    ...
    try {
        if (uid && postId && commentId) {
            const objectCommentId = (0, helpers_1.stringToObjectId)(commentId);
            const objectPostId = (0, helpers_1.stringToObjectId)(postId);
            const objectUserId = (0, helpers_1.stringToObjectId)(uid);
...
const incrementReplyLikeController = async (req, res) => {
    ...
    try {
        if (commentId && replyId && userId) {
            const objectReplyId = (0, helpers_1.stringToObjectId)(replyId);
            const objectCommentId = (0, helpers_1.stringToObjectId)(commentId);
            const objectUserId = (0, helpers_1.stringToObjectId)(userId);
