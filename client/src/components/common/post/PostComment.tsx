...
const PostComment = ({
  ...
  return (
    <>
      <div className="pt-0.5 md:pt-1 pb-2 flex flex-col px-2 w-full">
        {modifiedComments
          ...
          .map((comment: any) => (
            <React.Fragment key={comment._id}>
                          ...
                          <div className="space-x-1 w-full">
                            <span>
                              {!expandComment && comment.comment.length > 100
                                ? comment.comment.slice(0, textLengthForExpand)
                                : comment.comment}
                            </span>
              ...
              <WriteReply
                isReply={replyCommentId === comment._id}
                commentObject={replyCommentId === comment._id && comment}
