  ...
  return (
    <>
      <div className="bg-secondary rounded ps-2 pe-4 py-2 flex items-center gap-x-3">
        ...
        <div className="bg-gray-500 hover:bg-gray-400 w-full rounded-xl py-1 px-4 cursor-pointer h-8 flex flex-col justify-center text-slate-300 hover:text-slate-100">
